## Here we have 2 functions which inverse and cache a matrix
## In this way we say time and memory 

## This is the core code to start the creation of the special matrix which will cache
## its inverse
